...
const VIEWS = {
  ...
  room: ['default'],
  props: ['default', 'cat-lit', 'fuse-out', 'vortex-mid', 'wine-drunk', 'globe-spinning', 'vase-empty', 'vase-leaf', 'rain', 'fine-burning', 'dark', 'peep-fallen', 'konami-house', 'deck-out', 'cross-open', 'piano-playing'],
  table: ['default'],
  pepe: ['default'],
  ...
  walk: ['home', 'fireplace', 'doorway', 'case', 'piano', 'table'],
