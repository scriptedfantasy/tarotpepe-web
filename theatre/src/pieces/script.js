...
const CARDS = {
  ...
  'king-of-wands': {
    ...
    do: ['Give the small lion something to guard. Something small. It will grow into the guarding.', 'Then stand back from it. You have been leaning over this one for years.'],
  },
};
